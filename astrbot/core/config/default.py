            ...
            "provider": {
                ...
                "config_template": {
                    ...
                    "Inception": {
                        "id": "inception",
                        "provider": "inception",
                        "type": "inception_chat_completion",
                        "provider_type": "chat_completion",
                        "enable": True,
                        "key": [],
                        "model": "mercury-2",
                    ...
                    "DashScope Coding (OpenAI)": {
                        "id": "dashscope_coding_openai",
                        "provider": "dashscope",
                        "type": "dashscope_coding_openai_chat_completion",
                        "provider_type": "chat_completion",
                        "enable": True,
                        "key": [],
                    ...
                    "DashScope Coding (Anthropic)": {
                        "id": "dashscope_coding_anthropic",
                        "provider": "dashscope",
                        "type": "dashscope_coding_anthropic_chat_completion",
                        "provider_type": "chat_completion",
                        "enable": True,
                        "key": [],
